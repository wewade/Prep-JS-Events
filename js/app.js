...
document.getElementById().addEventListener('click', something);

function sayQuote(){
  something.getElementById().something = "Our lives are defined by opportunities; even the ones we miss.";
}
